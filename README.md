...
# Added
Added trigger for power on hours
Forked from https://git.zabbix.com/projects/ZBX/repos/zabbix/browse/templates/module/smart_agent2
...
|Zabbix_raw_items |SMART [{#NAME}]: Get disk attributes |<p>-</p> |ZABBIX_PASSIVE |smart.disk.get[{#PATH},"{#RAIDTYPE}"] |
